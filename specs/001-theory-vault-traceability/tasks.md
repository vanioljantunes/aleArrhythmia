...
- [ ] T039 [P] [US4] (Partly done 2026-09-24: Cardiac Atlas Project biventricular modes surveyed, licence unknown. Still missing: an atrial atlas, and any second ventricular atlas.) Write one literature note per open cardiac atlas found, with licence and anatomical coverage (FR-025)
