...
|---|---|---|---|---|
| 1 | Where does the project live? | Raised by the author, not offered: the project should have a repository of its own | Own public repository | [[ADR-0001-repository-layout]] |
...
## Where the files started

| Date | Detail |
|---|---|
| Before 2026-09-20 | Planning files drafted in a local working folder |
| 2026-09-20 | Repository created and files moved in, before any decision record existed |
