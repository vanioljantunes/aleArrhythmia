...
| [[ADR-0010-study-values-on-the-study-shell]] | A study's own voltage or activation time may colour that study's shell in patient mode, labelled as the study's | accepted |
